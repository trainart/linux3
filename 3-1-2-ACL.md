...
> `ls` shows `+` indicator where there is ACL
> So if you see `+`, in addition to `ls -l` you might want to run `getfacl` for that file/directory to get clear picture of real permissions.
