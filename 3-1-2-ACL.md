...
> So if you see `+`, in addition to `ls -l` you might want to run `getfacl` for that file/directory <br>
> to get clear picture of real permissions.

The same inside the directory list - after `.`
